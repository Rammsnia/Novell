...
screen main_menu():
    ...
    imagemap:
        ...
        hotspot(98,449,225,75) action Start()
        hotspot(98,552,315,75) action ShowMenu("load")
        hotspot(98,679,341,75) action ShowMenu("preferences")
        hotspot(98,812,339,75) action ShowMenu("help")
        hotspot(98,947,175,68) action Quit(confirm=True)
        hotspot(1634,947,186,68) action ShowMenu("about")
